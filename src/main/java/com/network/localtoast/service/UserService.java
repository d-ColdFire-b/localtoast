...
import com.network.localtoast.domain.Role;
import com.network.localtoast.domain.User;
import com.network.localtoast.repos.UserRepo;
    ...
    private void sendMessage(User user) {
        if (!StringUtils.isEmpty(user.getEmail())){
            String message = String.format(
                    "Hello, %s! \n" +
                            "Welcome to Revquean Messenger. Please, visit next link: http://localhost:8080/activate/%s",
                    user.getUsername(),
